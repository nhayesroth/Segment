 ...
 * Each port allows clients to retrieve values from Redis, but they use separate
 * protocols:
 * <ul>
 * <li>8080: HTTP GET
 * <li>8124: Resp GET
...
public class Server {
  ...
  /**
   * Main server method, which initializes the cache and starts both listening
   * for HTTP and RESP connections.
   */
  ...
  private void startRespServer() throws IOException {
    respServer = new RespServer(cache, configuration, redisClient);
